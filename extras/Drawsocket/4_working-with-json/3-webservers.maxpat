...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 43.0, 616.0, 147.0 ],
					"text" : "One of the features of linking the webserver to Max is that you can send  updates to the page in real time. However, JSON files created with Drawsocket can also be used with regular servers in \"non-realtime\"mode.\n\nIf you have access to a webserver, you can run the Drawsocket client side code and use a URL address parsing system to fetch JSON files and prefixes.\n\nIn the folder containing this patch, is a subfolder called \"webserver\" which contains an example setup for a remote Drawsocket client running disconnected from Max."
				}
